...
goog.require( 'zz.ui.mdl.button.controllers.Button' );
...
zz.ui.mdl.button.bootstrap = function( ){
	...
	goog.ui.registry.setDecoratorByClassName( zz.ui.mdl.button.enums.CSS.ROOT_ELEMENT, function( ){

		return new zz.ui.mdl.button.controllers.Button( );
	} );
...
window[ 'zz.ui.mdl.button.bootstrap' ] = zz.ui.mdl.button.bootstrap;