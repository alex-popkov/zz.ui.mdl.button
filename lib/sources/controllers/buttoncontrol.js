/**
 * @fileoverview Provide zz.ui.mdl.controllers.ButtonControl class.
 * @license Apache-2.0
 * @author author buntarb@gmail.com (Artem Lytvynov)
 */

goog.provide( 'zz.ui.mdl.controllers.ButtonControl' );
...
goog.require( 'zz.ui.mdl.views.ButtonView' );
 ...
 * @constructor
 */
zz.ui.mdl.controllers.ButtonControl = function( opt_content, opt_renderer, opt_domHelper ){

    goog.base(

        this,
        opt_content,
        opt_renderer || zz.ui.mdl.views.ButtonView.getInstance( ),
        opt_domHelper );
...
goog.inherits( zz.ui.mdl.controllers.ButtonControl, zz.ui.mdl.Controllers.BaseControl );
goog.tagUnsealableClass( zz.ui.mdl.controllers.ButtonControl );

/**
 * Store constants in one place so they can be updated easily.
 * @enum {string | number}
 */
zz.ui.mdl.controllers.ButtonControl.CONST = { };
 ...
 * @enum {string}
 */
zz.ui.mdl.controllers.ButtonControl.CSS = {
 ...
 * @override
 */
zz.ui.mdl.controllers.ButtonControl.prototype.enterDocument = function( ){
    ...
    if( goog.dom.classlist.contains( this.getElement( ), zz.ui.mdl.controllers.ButtonControl.CSS.RIPPLE_EFFECT ) ){
        ...
        ripple.decorate(
            ...
            goog.dom.getElementByClass(
                ...
                zz.ui.mdl.controllers.ButtonControl.CSS.RIPPLE_CONTAINER,
                this.getElement( ) ) );
    }
};
 ...
 * @inheritDoc
 **/
zz.ui.mdl.controllers.ButtonControl.prototype.disposeInternal = function( ){
 ...
 * @this {zz.ui.mdl.controllers.ButtonControl}
 * @private
 */
zz.ui.mdl.controllers.ButtonControl.prototype.mouseListener_ = function( event ){
 ...
 * @override
 */
zz.ui.mdl.controllers.ButtonControl.prototype.handleKeyEventInternal = function( e ){
 ...
 */
zz.ui.mdl.controllers.ButtonControl.prototype.setEnabled = function( enable ){

    zz.ui.mdl.controllers.ButtonControl.superClass_.setEnabled.call( this, enable );
